...
from app.naturalsentinel.agents.agency_mortgage_agent import AgencyMortgageAgent
from app.naturalsentinel.agents.ai_governance_agent import AIGovernanceAgent
from app.naturalsentinel.agents.alert_agent import AlertAgent
from app.naturalsentinel.agents.capital_optimization_agent import (
    CapitalOptimizationAgent,
)
from app.naturalsentinel.agents.compliance_tracker import ComplianceTrackerAgent
from app.naturalsentinel.agents.counterparty_risk_agent import CounterpartyRiskAgent
from app.naturalsentinel.agents.cybersecurity_agent import CybersecurityAgent
from app.naturalsentinel.agents.data_privacy_agent import DataPrivacyAgent
from app.naturalsentinel.agents.leveraged_lending_agent import LeveragedLendingAgent
from app.naturalsentinel.agents.liquidity_ratio_agent import LiquidityRatioAgent
from app.naturalsentinel.agents.model_risk_agent import ModelRiskAgent
from app.naturalsentinel.agents.optimization_constraint_agent import (
    OptimizationConstraintAgent,
)
from app.naturalsentinel.agents.platform_compliance_agent import PlatformComplianceAgent
from app.naturalsentinel.agents.regulatory_reporting_agent import (
    RegulatoryReportingAgent,
)
from app.naturalsentinel.agents.securities_financing_agent import (
    SecuritiesFinancingAgent,
)
from app.naturalsentinel.agents.stress_testing_agent import StressTestingAgent
from app.naturalsentinel.agents.telecom_spectrum_agent import TelecomSpectrumAgent
