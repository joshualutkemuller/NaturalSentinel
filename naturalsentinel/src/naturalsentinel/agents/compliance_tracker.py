...
The agent adds value beyond calling skills individually by:
  - Injecting smart defaults based on the urgency of findings
  - Routing straight to OVERDUE items first in its return payload
  - Providing a ready-to-use compliance calendar dictionary
...
class ComplianceTrackerAgent:
    ...
    def __init__(self, runtime: Any):
        """
        Args:
            runtime: An AgentRuntime instance with compliance_deadline,
                     generate_briefing, and export_report skills registered.
        """
    ...
    def run(
        ...
        Args:
            look_ahead_days: Days ahead to consider "due soon" (default 30).
            domain_filter: Restrict to a single agency code (e.g. "sec").
            export_format: Report format — "markdown", "json", or "csv".
            include_briefing: Whether to generate an LLM deadline briefing.
            limit: Max analyses to inspect from memory.
