...
def score_field(field_name: str, predicted_val: object, expected_val: object) -> FieldScore:
    ...
    if field_name in DATE_FIELDS:
        if predicted_val is None and expected_val is None:
            ...
            score = 1.0 if str(predicted_val).strip() == str(expected_val).strip() else 0.0
        return FieldScore(
            field=field_name,
            score=score,
            predicted=predicted_val,
