...
MOCK_ANALYSES: dict[str, dict] = {
    ...
    "FHFA-2026-0310-G": {
        ...
        "change_type": "notice",
        "severity": "medium",
        "affected_business_lines": ["Agency Lending", "Agency MBS / TBA", "GSE Collateral Management", "Conforming Loan Origination", "Mortgage Banking", "Prepayment Modelling"],
        "affected_regulations": ["FHFA Conforming Loan Limits (12 USC 1717)", "Fannie Mae Selling Guide", "Freddie Mac Single-Family Seller/Servicer Guide", "Securities Lending Collateral Schedules"],
    ...
    "OCC-2026-0308-H": {
        ...
        "change_type": "guidance",
        "severity": "high",
        "affected_business_lines": ["Secured Lending", "Prime Lending", "Leveraged Finance", "Credit Portfolio Management", "Capital Planning", "Commercial Real Estate Lending"],
        "affected_regulations": ["OCC Bulletin 2013-9 (Leveraged Lending)", "Federal Reserve SR 13-3", "FDIC FIL-13-2013", "Dodd-Frank Act Section 165"],
    ...
    "FINRA-2026-0305-I": {
        ...
        "change_type": "final_rule",
        "severity": "high",
        "affected_business_lines": ["Agency Lending", "Agency MBS / TBA", "Margin Lending", "Repo / Reverse Repo", "Prime Brokerage", "Customer Margin Accounts", "Broker-Dealer Operations"],
        "affected_regulations": ["FINRA Rule 4210", "FINRA Rule 4220", "SEC Regulation T", "Exchange Act Section 7"],
    ...
    "CFTC-2026-0301-J": {
        ...
        "change_type": "final_rule",
        "severity": "high",
        "affected_business_lines": ["Derivatives / Swaps", "Initial Margin (IM/SIMM)", "Counterparty Credit Risk", "CVA / MVA Hedging", "FX Prime Brokerage", "XVA Desk"],
        "affected_regulations": ["CFTC Regulation 23.150-161 (Margin)", "Dodd-Frank Act Section 4s(e)", "ISDA SIMM v2.7", "Basel III Uncleared Margin Rules"],
    ...
    "FDIC-2026-0225-K": {
        ...
        "change_type": "final_rule",
        "severity": "high",
        "affected_business_lines": ["Commercial Banking", "Deposit Funding", "Capital Adequacy", "Secured Lending", "Stress Testing", "Brokered Deposits"],
        "affected_regulations": ["Federal Deposit Insurance Act Section 7 (12 USC 1817)", "12 CFR Part 327", "FDIC Assessment Rate Schedule"],
    ...
    "BASEL-2026-0315-L": {
        ...
        "change_type": "final_rule",
        "severity": "critical",
        "affected_business_lines": ["Capital Optimization", "RWA Modelling", "SA-CCR", "Leverage Ratio / SLR", "NSFR / LCR", "Output Floor", "Internal Models (FRTB / IRBA)", "XVA Desk"],
        "affected_regulations": ["Basel III / Basel IV (BCBS d424)", "CRR3 (EU)", "Basel IV Output Floor", "SA-CR", "SA-CCR", "FRTB"],
    ...
    "FED-2026-0312-M": {
        ...
        "change_type": "notice",
        "severity": "critical",
        "affected_business_lines": ["Stress Testing", "Capital Planning", "Repo / Reverse Repo", "Prime Lending", "Secured Lending", "Leveraged Finance", "Capital Optimization"],
        "affected_regulations": ["Dodd-Frank Act Section 165(i)", "12 CFR Part 252 (Regulation YY)", "Federal Reserve SR 15-18", "CCAR Instructions 2026"],
    ...
    "FED-2026-0303-N": {
        ...
        "change_type": "guidance",
        "severity": "high",
        "affected_business_lines": ["Model Risk Management", "Capital Optimization", "RWA Modelling", "Stress Testing", "Credit Portfolio Management", "XVA Desk"],
        "affected_regulations": ["Federal Reserve SR 11-7", "OCC Bulletin 2011-12", "Federal Reserve SR 15-18", "Dodd-Frank Section 165"],
        "compliance_deadline": None,
        "action_items": [
    ...
    "SEC-2026-0295-O": {
        ...
        "change_type": "final_rule",
        "severity": "high",
        "affected_business_lines": ["Securities Lending", "Prime Brokerage", "Customer Margin Accounts", "Repo / Reverse Repo", "Broker-Dealer Operations"],
        "affected_regulations": ["SEC Rule 15c3-3", "Exchange Act Section 15(c)(3)", "SEC Rule 15c3-1 (Net Capital)", "FINRA Rule 4160"],
    ...
    "CFTC-2026-0310-P": {
        ...
        "change_type": "guidance",
        "severity": "medium",
        "affected_business_lines": ["SA-CCR", "Counterparty Credit Risk", "Repo / Reverse Repo", "Derivatives / Swaps", "XVA Desk", "Capital Optimization"],
        "affected_regulations": ["CFTC Regulation 23.151 (SA-CCR)", "Basel III SA-CCR Framework", "17 CFR Part 23", "CFTC Capital Rules"],
